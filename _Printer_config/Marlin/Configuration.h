...
#define STRING_SPLASH_LINE2 "Red Dragon"        // will be shown during bootup in line 2
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 1000, 1000, 100, 45 }
...
#define Z_SERVO_ANGLES {200,110}  // Z Servo Deploy and Stow angles
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.63   // Z offset: -below +above  [the nozzle]
